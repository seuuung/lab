...
function testFinal(name, eye, center, cubePos, lightPos, lightTarget, fov, w, h, blockSize = 0.82) {
    ...
    console.log(`  Center X: Cube=${sCube.x.toFixed(1)}px, Shadow=${sShadow.x.toFixed(1)}px (Mid: ${(w/2).toFixed(1)}px)`);
    console.log(`  Vertical Clear Gap: ${verticalGap.toFixed(1)}px ${verticalGap > 15 ? '✅ EXCELLENT' : '❌ CLASH'}`);
}

// Mobile 390x844
testFinal('Mobile Final: Eye (8, 6, 26), Cube (-1.0, -3.2, 0)', 
    [8, 6, 26], [0, 0, -4], 
    [-1.0, -3.2, 0], 
    [0, -18, 28], [0, -2, 0], 
    48, 390, 844
...
// Desktop 1200x800
testFinal('Desktop Final: Eye (10, 7, 24), Cube (-1.0, -2.4, 0)', 
    [10, 7, 24], [0, 0, -3], 
    [-1.0, -2.4, 0], 
    [0, -16, 28], [0, -2, 0], 
    42, 1200, 800
